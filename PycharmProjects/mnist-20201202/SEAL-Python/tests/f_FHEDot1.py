...
def FHEDot(inputs_x, inputs_w):
    ...
    for i in range(row_inputs_x):#8,9
      ...
      #  x=-1
        for k in range(row_inputs_w):  #676,9
...
inputs_w = np.array([[0,2,5,4],[1,3,5,6],[3,5,8,3]])  #3*2=6
inputs_w2 = np.array([[0,2,55,124],[1,35.89,5,6],[3,5,8,3]])  #3*2=6
output_2=np.dot(inputs_x,np.transpose(inputs_w))
print(output_2)
outputs_xw = FHEDot(inputs_x,inputs_w)
print(outputs_xw)

print(np.add(output_2,-outputs_xw))

output_2=np.dot(inputs_x,np.transpose(inputs_w2))
outputs_xw = FHEDot(inputs_x,inputs_w2)
print(np.add(output_2,-outputs_xw))'''